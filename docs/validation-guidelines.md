...
- **필수 입력값 확인**: 제목, 설명, 일정 타입, 시작/마감 시간, 중요도, 난이도는 폼 제출 전에 즉시 검증합니다.
- **시간 관계**: 마감 시간이 시작 시간보다 빠른지 여부를 체크하고 에러 메시지를 필드 하단에 즉시 표시합니다.
- **범위 제약**: 중요도는 1~9, 난이도는 21 이하의 피보나치 수(1, 2, 3, 5, 8, 13, 21)만 허용하고 벗어나는 입력은 막거나 에러 메시지를 노출합니다.
...
| --- | --- | --- | --- |
| 일정 추가/수정 폼 | 필수값, 시간, 범위(중요도/난이도), 의존성 중복 | 사이클, 일정 충돌 | 필드 하단 + 상단 배너 |
