...
const slides = [
  ...
  {
    title: '핵심 기능 한눈에',
    description: '중요도·긴급도 기반 우선순위, 의존 일정 관리, 실시간 진행률을 지원해요.',
    bullets: ['슬라이더 기반 중요/긴급도 조절', '이전·이후 일정 연결로 병목 방지', '주간 통계와 미완료 알림 배너'],
  },
  {
    title: '팀 협업을 위한 흐름',
  ...
  return (
    <div className="landing">
      <header className="landing__hero">
        ...
        <p>
          중요도와 긴급도로 우선순위를 세우고, 의존 일정까지 한 번에 연결하는 모바일 최적화
          일정 관리 서비스입니다.
        </p>
